...
If you plan to use PCAPdroid to perform packet analysis, check out <a href="#14-packet-analysis">the related section</a> below.
...
If you need to perform a low level analysis on the L3 or L4 headers of the packets or on the size/timing of packets, then the non-root capture may not be appropriate for your task. You should instead use the [root capture](advanced_features#44-root-capture), which provides an almost 1:1 view on the traffic of your device without any modifications.
