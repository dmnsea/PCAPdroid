...
In its default configuration, PCAPdroid does not perform any connection on its own. Some optional features which the user can enable, like the malware detection, may require contacting third-party servers.
