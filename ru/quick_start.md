...
Если вы планируете использовать PCAPdroid для проведения анализа пакетов, ознакомьтесь c  [соответствующим разделом](#14-анализ-пакетов) ниже.
...
Если вам необходимо провести низкоуровневый анализ пакетов (заголовки сетевого (L3) или транспортного (L4) уровня) или их размеры/тайминги, тогда захват в обычном режиме может не подойти для ваших целей. Вместо него необходимо использовать [захват трафика в Root-режиме](advanced_features#44-захват-трафика-с-правами-root), который предоставляет данные по трафику устройства "как есть" без каких-либо модификаций.
